...
import { firebaseAuth } from "src/common/configs/firebase-config";
import { RecoilAtomKeys } from "src/common/configs/recoil/recoil-atom-key";
import { useRouter } from "next/router";
import { SIGN_NO_EMAIL_VERIFIED_PAGE } from "src/common/configs/url/page-url";
import { FirebaseError } from "@firebase/app";
import { selectErrorMessage } from "src/common/lib/auth/select-error-message";
import { UseCreateAccount } from "@common/api/get/use-create-account";
